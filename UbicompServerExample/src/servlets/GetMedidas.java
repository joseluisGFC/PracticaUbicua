 ...
 */
@WebServlet("/GetMedidas")
public class GetMedidas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			ArrayList<Medida> valores =  Logic.getMedidasFromDB();//llamas a logic DB para extraer el contenido de la base de datos
